<template>
    <nav class="fixed flex items-center justify-between w-screen h-24 text-center bg-black">
      <a href="#" @click.prevent="scrollToTop">
        <img routerlink="/" class="ml-8 duration-300 hover:scale-110 hover:ease-in-out h-10 w-10 rounded-full hover:ring-[#00B15A] hover:ring-offset-2 hover:ring-offset-black hover:ring-2 hover:outline-offset-2" src="../assets/face.webp" alt="Photo de profil">
      </a>
