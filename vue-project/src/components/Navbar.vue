<template>
    <nav class="fixed flex items-center justify-between w-screen h-24 text-center bg-black">
      <a href="#" @click.prevent="scrollToTop">
        <img routerlink="/" class="ml-8 duration-300 md:hover:scale-110 md:hover:ease-in-out h-10 w-10 rounded-full active:ring-[#00B15A] md:hover:ring-[#00B15A] active:ring-offset-2 md:hover:ring-offset-2 active:ring-offset-black md:hover:ring-offset-black active:ring-2 md:hover:ring-2 active:outline-offset-2 md:hover:outline-offset-2" src="../assets/face.webp" alt="Photo de profil de Mathis Chouffot">
      </a>
